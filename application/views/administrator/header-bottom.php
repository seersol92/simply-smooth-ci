   ...
   <div class="main-menu-content">
      <ul class="main-navigation">
         ...
         <li class="nav-item">
            ...
            <ul class="tree-1">
               <li><a href="<?php echo base_url(); ?>administrator/new-template">Add Email Template</a></li>
               <li><a href="<?php echo base_url(); ?>administrator/email-management">View All Email Template</a></li>
            </ul>
         </li>
         <li class="nav-item">
            <a href="#!">
